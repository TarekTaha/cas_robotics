function result=bridgeSection
    ...
    section1 = shift(section1, [-robotOffset, -(surface.breadth - flange.breadth / 2), 1.770 - 0.540]);
    ...
    % move origin to robot base
    section2 = shift(section2, [-robotOffset, surface.breadth - flange.breadth / 2, 1.770 - 0.540]);
