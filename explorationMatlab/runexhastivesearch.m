...
title('Discretised Configuration Space');
xlabel('Joint 1 (rads)')
ylabel('Joint 2 (rads)')
zlabel('Joint 3 (rads)')
grid on;

display(['With inc between steps of joints 1->3 of: [' num2str(angle_inc*180/pi),'] degrees, and sample space of: ', num2str(size(all_data,1)),' voxels']);
