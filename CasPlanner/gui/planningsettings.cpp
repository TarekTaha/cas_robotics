        ...
        ui(new Ui::PlanningSettings)
{
    ...
    connect(ui->bridgeTest,         SIGNAL(stateChange(int)),this,SLOT(updateCheckboxStates(int)));
    connect(ui->connectNodes,       SIGNAL(stateChange(int)),this,SLOT(updateCheckboxStates(int)));
    connect(ui->regGrid,            SIGNAL(stateChange(int)),this,SLOT(updateCheckboxStates(int)));
    connect(ui->obstPenalty,        SIGNAL(stateChange(int)),this,SLOT(updateCheckboxStates(int)));
    connect(ui->expandObst,         SIGNAL(stateChange(int)),this,SLOT(updateCheckboxStates(int)));

    connect(ui->showSearchTree,     SIGNAL(stateChange(int)),this,SLOT(updateDisplaySettings(int)));
    connect(ui->showSearchSpaceTree,SIGNAL(stateChange(int)),this,SLOT(updateDisplaySettings(int)));
    connect(ui->showPaths,          SIGNAL(stateChange(int)),this,SLOT(updateDisplaySettings(int)));
    connect(ui->showRobotTrail,     SIGNAL(stateChange(int)),this,SLOT(updateDisplaySettings(int)));
    connect(ui->showSearchSpaceSamples,SIGNAL(stateChange(int)),this,SLOT(updateDisplaySettings(int)));
