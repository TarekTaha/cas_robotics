...
void OGRenderer::initializeGL()
{
    glClearColor(0.70f, 0.7f, 0.7f, 1.0f);
    // Some stupid crap for QT
    renderText(0,0,0,""); 
    displayList = glGenLists(1);
    qDebug("Display list is: %d", displayList); 
}

//void OGRenderer::renderRobots(QVector<RobotLocation *> robotLocations, bool renderRobot)
//{
//    glColor4f(0,0,0,1);
...
//void OGRenderer::renderPointcloud(orca::PointcloudPtr pointcloud, float in_fudgeFactor){
...
//}
//
//void OGRenderer::renderSnap(orca::SnapPtr snap, float in_fudgeFactor){
...
void OGRenderer::resizeGL(int w, int h)
{
